...
struct AppPaths {
    ...
    static juce::File data(){auto d=portable()?executableDir().getChildFile("Data"):juce::File::getSpecialLocation(juce::File::userApplicationDataDirectory).getChildFile("Modificador de Voz");d.createDirectory();return d;}
    ...
    static juce::File logs(){auto d=portable()?data().getChildFile("Logs"):localBase().getChildFile("Modificador de Voz").getChildFile("Logs");d.createDirectory();return d;}
    static juce::File cache(){auto d=portable()?data().getChildFile("Cache"):localBase().getChildFile("Modificador de Voz").getChildFile("Cache");d.createDirectory();return d;}
};
}
