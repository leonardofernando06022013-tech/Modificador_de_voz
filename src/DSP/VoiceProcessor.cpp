...
void VoiceProcessor::reset(){ pitch.reset(); compressor.reset(); limiter.reset(); chorus.reset(); delay.reset(); reverb.reset(); gateEnvelope=0; hpX.fill(0); hpY.fill(0); lpY.fill(0); formantLow.fill(0); dcX.fill(0); dcY.fill(0); }
